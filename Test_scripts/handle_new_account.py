...
class CreatNewAccount:
    ...
    @staticmethod
    def creat_new_account(url=url, pwd="11111111", type="0", reg_name=None,
    ...
    def handle_new_user(self):
        ...
        datas={}
        datas.update(self.creat_new_account(reg_name="admin",type="1"))
        datas.update(self.creat_new_account(reg_name="invest_user"))
        datas.update(self.creat_new_account(reg_name="loan_user"))
